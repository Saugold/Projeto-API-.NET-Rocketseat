...
namespace PassIn.Application.UseCases.Events.RegisterAttendee
{
	public class RegisterAttendeeOnEventUseCase
	{
		...
		private void Validate(Guid eventId,RequestRegisterEventJson request)
		{
			...
			{
				throw new ConflictException("You can not regiter twice on the same event.");
			}

			var atendeesForEvent = _dbContext.Attendees.Count(attendee => attendee.Event_Id == eventId);
			if(atendeesForEvent > eventEntity.Maximum_Attendees)
			{
